...
function exportHeaderHTML(subtitle) {
  return `
    <div style="display:flex; align-items:center; gap:10px; padding:28px 32px 14px; border-bottom:3px solid #1d4ed8;">
      <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#1d4ed8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
      <div>
...
window.generateExportPreview = async function () {
  ...
  // Give the browser a frame to finish layout before rasterizing.
...
window.downloadExportedImage = function () {
  if (!window._exportDataUrl) return;
  const a = document.createElement("a");
  a.href = window._exportDataUrl;
  a.download = window._exportFilename || "AICSchedule_export.png";
